...
/**
 * Abstract base class for {@link MultipleTypeDto} specific assertions - Generated by CustomAssertionGenerator.
 */
@javax.annotation.Generated(value="assertj-assertions-generator")
public abstract class AbstractMultipleTypeDtoAssert<S extends AbstractMultipleTypeDtoAssert<S, A>, A extends MultipleTypeDto> extends AbstractObjectAssert<S, A> {

  /**
   * Creates a new <code>{@link AbstractMultipleTypeDtoAssert}</code> to make assertions on actual MultipleTypeDto.
   * @param actual the MultipleTypeDto we want to make assertions on.
   */
  protected AbstractMultipleTypeDtoAssert(A actual, Class<S> selfType) {
   ...
   */
  public S hasCodeValue(dev.sample.common.code.CodeVo codeValue) {
    // check that actual MultipleTypeDto we want to make assertions on is not null.
    isNotNull();
    ...
    // null safe check
    dev.sample.common.code.CodeVo actualCodeValue = actual.getCodeValue();
